...
const { uploadVideo, uploadNotes, uploadPostImages, uploadTeacherResources  } = require('../config/cloudinary');
...
router.get('/learner/historical-positions', schoolController.getLearnerHistoricalPositions);
router.post('/learner/bulk-historical-positions', schoolController.getBulkHistoricalPositions); 

// Performance routes
// Performance routes - FIXED: Use schoolController object
router.get('/:schoolId/performance/classes', schoolController.getPerformanceClasses);
router.get('/:schoolId/performance/terms', schoolController.getPerformanceTerms);
router.get('/:schoolId/performance/exam-types', schoolController.getPerformanceExamTypes);
router.get('/:schoolId/performance/exam-names', schoolController.getPerformanceExamNames);
router.get('/:schoolId/performance/filtered', schoolController.getFilteredSchoolPerformance);
...
router.get('/assignments/id/:assignmentId', schoolController.getAssignmentDetails);
router.get('/assignments/:className', schoolController.getAssignmentsByClass);
router.get('/teachers/:teacherId/assignments', schoolController.getTeacherAssignments);
router.post('/assignments/id/:assignmentId/submit', schoolController.submitAssignment);
router.get('/assignments/id/:assignmentId/responses', schoolController.getAssignmentResponses);
router.get(
...
// ========================
router.get('/learner/:learnerId/career-insights', schoolController.getCareerInsights);
router.post('/update-career-insights', schoolController.updateCareerInsightsManual);
router.get('/debug-learner/:learnerId', schoolController.debugLearnerData);
router.get('/learner/:learnerId/interests', schoolController.getLearnerInterests);
...
router.post('/upload-video', uploadVideo.single('video'), schoolController.uploadVideo);
...
router.get('/parent/:parentId/special-events', schoolController.getSpecialEventsForParent);

// ========================
// Administrative Routes
// ========================
router.post('/transfer-requests', schoolController.submitTransferRequest);
router.get('/parents/:parentId/transfer-requests', schoolController.getParentTransferRequests);
router.get('/:schoolId/transfer-requests', schoolController.getSchoolTransferRequests);
router.patch('/transfer-requests/:requestId', schoolController.updateTransferRequestStatus);
...
router.put('/update-fee-structure/:id', schoolController.updateFeeStructureById); 
...
router.get('/parent/:parentId/fees/:schoolId', schoolController.getStudentFeesForParent);
// Add these new routes to your financial routes

router.delete('/fee-structure/:feeStructureId', schoolController.deleteFeeStructure);
router.get('/:schoolId/filtered-fee-structures', schoolController.getFilteredFeeStructures);

// ========================
// Discipline Routes
// ========================
router.post('/report-indiscipline', schoolController.reportIndisciplineCase);
router.get('/learner/:learnerId/indiscipline-cases', schoolController.getIndisciplineCasesForLearner);
router.get('/parent/:parentId/indiscipline-cases', schoolController.getIndisciplineCasesForParent);

// ========================
// Notes Routes
// ========================
router.post('/upload-notes', uploadNotes.single('file'), schoolController.uploadNotes);
...
router.get('/:schoolId/teachers/:teacherId/assignments/count', schoolController.getTeacherAssignmentsCount);
router.get('/:schoolId/teachers/:teacherId/videos/stats', schoolController.getTeacherVideoStats);
...
router.get('/admin/validate-token', verifyAdminToken, schoolController.validateAdminToken);
router.get('/admin/schools', verifyAdminToken, schoolController.getAllSchools);
router.get('/admin/schools/:schoolId', verifyAdminToken, schoolController.getSchoolDetails);
router.get('/admin/schools/:schoolId/students', verifyAdminToken, schoolController.getSchoolStudents);
router.get('/admin/schools/:schoolId/teachers', verifyAdminToken, schoolController.getSchoolTeachers);
router.get('/admin/schools/:schoolId/parents', verifyAdminToken, schoolController.getSchoolParents);
...
// Post-related routes
router.post('/posts', uploadPostImages.array('images', 5), schoolController.createPost);
...
router.put('/posts/update', uploadPostImages.array('images', 5), schoolController.updatePost);
...
router.post('/teacher-resources', uploadTeacherResources.single('file'), teacherResourceController.uploadTeacherResource);
router.get('/teacher-resources', teacherResourceController.getAllTeacherResources);
router.get('/teacher-resources/categories', teacherResourceController.getResourceCategories);
// router.get('/teacher-resources/filter', teacherResourceController.getResourcesByClassAndSubject);
router.get('/teacher-resources/filter', teacherResourceController.getResourcesByFilter);

// Add this to your routes file
router.get('/teacher-resources/:id/download-url', teacherResourceController.getDownloadUrl);
...
router.get('/latest-amplified-events', schoolController.getLatestAmplifiedEvents);
...
router.get('/scheduled-exams', scheduledExamController.getScheduledExams);
router.get('/scheduled-exams/submitted-results', scheduledExamController.getSubmittedResults);
router.get('/:schoolId/exams/:examId/results/summary', scheduledExamController.getResultsSummary);

router.delete('/scheduled-exams/:examId', scheduledExamController.deleteScheduledExam);
router.put('/scheduled-exams/:examId', scheduledExamController.updateScheduledExam);
